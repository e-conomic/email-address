...
describe('index.spec.js', function() {
	...
	describe('.isValid', function() {
		...
		it('should return true if the host name has special chars like acents and umlauts', function() {
			expect(emailAddress.isValid('böb@example.com'), 'should handle umlaut in local').to.be.true;
			expect(emailAddress.isValid('bob@ëxample.com'), 'should handle umlaut in domain').to.be.true;
		});
	...
	describe('isMultipleValid', function() {
		...
		it('should return true if a string that has whitespaces has valid email adresses', function() {
			expect(emailAddress.isMultipleValid('  jane.doe@example.com,john.doe@example.com')).to.be.true;
			expect(emailAddress.isMultipleValid('jane.doe@example.com,john.doe@example.com  ')).to.be.true;
			expect(emailAddress.isMultipleValid('  jane.doe@example.com,john.doe@example.com  ')).to.be.true;
			expect(emailAddress.isMultipleValid('  jane.doe@example.com,   john.doe@example.com  ')).to.be.true;
